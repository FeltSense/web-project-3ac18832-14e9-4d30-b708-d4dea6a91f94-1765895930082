    ...
    <div className="grid md:grid-cols-4 gap-8 md:gap-12 lg:gap-16">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm leading-relaxed mb-6">
          Empowering businesses with innovative technology solutions that drive growth and transform industries.
        </p>
      ...
      <div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <a href="mailto:hello@techbusiness.com" className="text-gray-300 hover:text-white transition-colors text-sm">
              hello@techbusiness.com
            </a>
          </div>
          <div>
            <p className="text-gray-400 text-sm font-medium mb-1">Phone</p>
            <a href="tel:+1-800-TECH-BIZ" className="text-gray-300 hover:text-white transition-colors text-sm">
              +1 (800) TECH-BIZ
            </a>
          </div>
          <div>
